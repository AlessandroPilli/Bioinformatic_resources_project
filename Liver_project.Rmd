...
my_dir <- "C:/Users/alepi/OneDrive/Desktop/university/first year/second semester/bioinformatics/Bioinformatic Resources/project/"
setwd("C:/Users/alepi/OneDrive/Desktop/university/first year/second semester/bioinformatics/Bioinformatic Resources/project/")
setwd("D:/ALESSANDRO/UniTN/first_year/second semester/bioinformatics/Bioinformatic Resources/project")
...
```
  From the graph we analyzed the two most dense clusters (clusters 2 and 5):
1. cluster 5 present proteins that are highly related to the cell cycle confirming the pathway resulting from KEGG analysis (cell cycle), coded by the id *hsa04110*
